...
<form class="modal-content" name="myForm1" onsubmit="return signUpForm()" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
    <div class="container">
     ...
     <label for="name">License Number</b></label>
     <input type="text" placeholder="Enter License Number" name="lic" required>

      <label for="mob"><b>Mobile</b></label>
      <input type="text" placeholder="Enter Mobile Number" name="mob" required>

      <label for="email"><b>Administartor Email</b></label>
...
<div id="id02" class="modal2">
  ...
  <form name="myForm2" class="modal-content animate" id="login" onsubmit="return validateForm()" method="post" action="hosp home.php">
...
<?php
    ...
    if($name!="")
    {
        $users->insert([ 'Name' => $name,'Licence' => $lic,'Mobile' => $mob,'Email' => $email,'Location' => $loc,'Password' => $psw]);
    }
